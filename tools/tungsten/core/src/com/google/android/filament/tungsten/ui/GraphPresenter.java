...
public class GraphPresenter implements IPropertiesPresenter {
     ...
     */
    public void selectionChanged(List<String> selectedNodes) {
     ...
     */
    @Override
    public void propertyChanged(Node node, String propertyName, PropertyValue value) {
        mModel = mModel.graphByChangingProperty(node, propertyName, value);
        mGraphView.render(mModel);
        // todo: this works but is slow and inefficient
